...
router.post("/signup", async (req, res) => {
 ...
 try {
   ...
   const existingUser = await req.app.locals.db.collection("users").findOne({
     $or: [{ username }, { email }]
   });
   ...
   await req.app.locals.db.collection("lessons").insertMany(defaultLessons);
   await req.app.locals.db.collection("units").insertMany(defaultUnits);
   await req.app.locals.db.collection("exams").insertMany(defaultExams);
