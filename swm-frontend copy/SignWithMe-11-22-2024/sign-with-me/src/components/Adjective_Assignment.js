...
function ASLQuiz() {
  ...
  const translationSentences = [
    ...
    { english: "Do you think a cow would make a good pet?", asl: "YOU THINK COW GOOD PET?" },
    { english: "What is your favorite book?", asl: "YOUR FAVORITE BOOK, NAME?" },
    { english: "Where should we put dirty clothes?", asl: "CLOTHES DIRTY, SHOULD PUT WHERE?" },
  ];
