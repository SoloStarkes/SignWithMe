...
const VerbsPage = ({ navigate }) => {
  return (
    <section>
      ...
      <p style={{paddingLeft:'25%',fontSize:'24px'}}>In ASL, verbs can appear at the beginning, middle, or end of a sentence, depending on the emphasis.</p>
      ...
      <div className="tense-section">
        ...
        <div className="tense-content">
          <p> 
          <strong>
          Signing in present tense is simple — you sign close to your body, just like in a normal conversation.
          </strong>
          </p>
          <img src={Present} alt="Present Tense Example" className="tense-gif" />
        </div>
      </div>
      ...
      <div className="tense-section">
        ...
        <div className="tense-content">
          <p>
          <strong>
            Signing in past tense is done by signing <strong>finish</strong> at chest level at the beginning or end of the sentence.
            </strong>
            </p>
      ...
      <div className="tense-section">
        ...
        <div className="tense-content">
          ...
          <strong>
            ...
            For future tense, sign and say <strong>will</strong> at the end of the sentence. Signing farther away
            indicates a more distant future.
            </strong>
          ...
          <strong>
            ...
            <li>English: He can go later. <br /> Sign: HE GO — WILL</li>
            <li>English: Mike is walking over to my house. <br /> Sign: MY HOUSE — M-I-K-E — WALKING — WILL</li>
            </strong>
  ...
  return (
    <section>
      ...
      <div className="flashcards">
        <div className="flashcard red" tabIndex="0" onClick={() => enlargeGif(Red)}>
          <div className="front">Red</div>
          <div className="back">
            <img src={Red} alt="Sign for Red" />
          </div>
        </div>
        <div className="flashcard blue" tabIndex="0" onClick={() => enlargeGif(Blue)}>
          <div className="front">Blue</div>
          <div className="back">
            <img src={Blue} alt="Sign for Blue" />
          </div>
        </div>
        <div className="flashcard yellow" tabIndex="0" onClick={() => enlargeGif(Yellow)}>
          <div className="front">Yellow</div>
          <div className="back">
            <img src={Yellow} alt="Sign for Yellow" />
          </div>
        </div>
        <div className="flashcard green" tabIndex="0" onClick={() => enlargeGif(Green)}>
          <div className="front">Green</div>
          <div className="back">
            <img src={Green} alt="Sign for Green" />
          </div>
        </div>
        <div className="flashcard orange" tabIndex="0" onClick={() => enlargeGif(Orange)}>
...
const Quiz = () => {
    ...
    const checkAnswer = (selectedAnswer) => {
        ...
        if (selectedAnswer === correctAnswer) {
            ...
            setFeedback(`Incorrect. The correct answer is ${correctAnswer.toUpperCase()}.`);
        }
    ...
    return (
        <div style={{paddingLeft:'50px'}} className="quiz-container">
            ...
            {feedback && <div id="feedback" style={{ color: feedback.includes("Correct") ? "green" : "red" }}>{feedback}</div>}
            {showNextButton && <button id="next-question" onClick={loadNextQuestion}>Next Question</button>}
            {feedback.includes("Quiz Complete") && <button onClick={restartQuiz}>Restart Quiz</button>}
        </div>
    );
};
...
const App = () => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'colors':
        return <ColorsPage navigate={setCurrentPage} enlargeGif={setEnlargedGif} />;
    case 'quiz':
