...
//     imageK, imageL, imageM, imageN, imageO, imageP, imageQ, imageR, imageS, imageT,
//     imageU, imageV, imageW, imageX, imageY, imageZ
// ];
...
//         navigate('/quiz'); // Redirect to the Quiz component route
//     };

//     const handleCloseModal = () => {
//         if (quizPromptRef.current) {
//             quizPromptRef.current.style.display = "none"; // Close the modal
//         }
//     };
...
//         <div>
//             <div class = "letter">
//                 <img class="image" ref={aslImageRef} alt="ASL Letter" />
//             </div>
...
function AlphabetC() {
    ...
    const handleStartQuiz = () => {
        navigate('/src/quiz.js?assignment=' + encodeURIComponent(assignment));    
    };

    return (
        <div className="alphabet-container">
            <h1>ASL Alphabet</h1>
            <p>Current Assignment: {assignment}</p>
            ...
            <div className="letter-info">
                <p>Letter: {String.fromCharCode(65 + currentLetterIndex)}</p>
                <p>Progress: {currentLetterIndex + 1} / {aslImages.length}</p>
            </div>

            <div className="buttons">
                <button onClick={handlePrev} disabled={currentLetterIndex === 0}>Previous</button>
                <button onClick={handleNext} disabled={currentLetterIndex === aslImages.length - 1}>Next</button>
            </div>
